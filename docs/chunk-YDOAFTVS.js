...
var S = ["mat-icon-button", ""],
  N = ["*"];
var O = new v("MAT_BUTTON_CONFIG");
var L = [
  ...
  B = (() => {
    class e {
      ...
      set disableRipple(o) {
        (this._disableRipple = o), this._updateRippleDisabled();
      }
      _disableRipple = !1;
      get disabled() {
      ...
      set disabled(o) {
        (this._disabled = o), this._updateRippleDisabled();
      }
      _disabled = !1;
      ariaDisabled;
      disabledInteractive;
      constructor() {
        n(D).load(A);
        let o = n(O, { optional: !0 }),
          a = this._elementRef.nativeElement,
          t = a.classList;
        (this.disabledInteractive = o?.disabledInteractive ?? !1),
          (this.color = o?.color ?? null),
          this._rippleLoader?.configureRipple(a, {
            className: "mat-mdc-button-ripple",
          });
        for (let { attribute: C, mdcClasses: j } of L)
          a.hasAttribute(C) && t.add(...j);
      }
      ngAfterViewInit() {
      ...
      focus(o = "program", a) {
        o
          ? this._focusMonitor.focusVia(this._elementRef.nativeElement, o, a)
          : this._elementRef.nativeElement.focus(a);
      }
      _getAriaDisabled() {
      ...
      static ɵdir = w({
        ...
        inputs: {
          ...
          ariaDisabled: [2, "aria-disabled", "ariaDisabled", m],
          disabledInteractive: [
            2,
            "disabledInteractive",
            "disabledInteractive",
  ...
  class e extends B {
    ...
    static ɵcmp = c({
      ...
      hostBindings: function (a, t) {
        a & 2 &&
          (l("disabled", t._getDisabledAttribute())(
            "aria-disabled",
            t._getAriaDisabled()
          ),
          b(t.color ? "mat-" + t.color : ""),
          d("mat-mdc-button-disabled", t.disabled)(
            "mat-mdc-button-disabled-interactive",
            t.disabledInteractive
          )("_mat-animation-noopable", t._animationMode === "NoopAnimations")(
            "mat-unthemed",
            !t.color
      ...
      template: function (a, t) {
        a & 1 &&
          ...
          r(5, "span", 2)(6, "span", 3)),
          a & 2 &&
            d("mdc-button__ripple", !t._isFab)("mdc-fab__ripple", t._isFab);
      },
      styles: [
...
var at = (() => {
  class e extends B {
    ...
    static ɵcmp = c({
      ...
      template: function (a, t) {
        a & 1 && (u(), r(0, "span", 0), i(1), r(2, "span", 1)(3, "span", 2));
      },
      styles: [
...
var et = (() => {
  class e {
    ...
    static ɵmod = _({ type: e });
    static ɵinj = f({ imports: [p, I, p] });
  }
  return e;
})();
var nt = {
  ...
  jsonServerUrl: "https://positive-quotes-server.acelyalejeune.repl.com",
};
export { tt as a, at as b, et as c, nt as d };
