...
const CATEGORY_QUOTES = {
  motivational: [
    ...
    },
    {
      id: 'motivational-2',
      content:
        'Keep moving, even when progress arrives quietly.',
      author: 'Positive Quotes',
      tags: ['motivational'],
    },
    {
  ...
  inspirational: [
    {
      id: 'inspirational-1',
      content:
        'Let curiosity open the door that certainty keeps closed.',
      author: 'Positive Quotes',
      tags: ['inspirational'],
    },
    {
      id: 'inspirational-2',
      content:
        'The life you imagine begins with one honest choice.',
      author: 'Positive Quotes',
      tags: ['inspirational'],
    },
    {
  ...
  happiness: [
    ...
    },
    {
      id: 'happiness-2',
      content:
        'Make room for delight before the day becomes crowded.',
      author: 'Positive Quotes',
      tags: ['happiness'],
    },
    {
      id: 'happiness-3',
      content:
        'A peaceful minute is still a real piece of happiness.',
      author: 'Positive Quotes',
      tags: ['happiness'],
    },
  ],
  ...
  wisdom: [
    {
      id: 'wisdom-1',
      content:
        'Not every open door deserves your footsteps.',
      author: 'Positive Quotes',
      tags: ['wisdom'],
    },
    {
    ...
    },
    {
      id: 'wisdom-3',
      content:
        'Listen long enough to notice what urgency is trying to hide.',
      author: 'Positive Quotes',
      tags: ['wisdom'],
    },
  ],
  ...
  love: [
    {
      id: 'love-1',
      content:
        'Love is attention given without rushing toward the next thing.',
      author: 'Positive Quotes',
      tags: ['love'],
    },
    {
      id: 'love-2',
      content:
        'Care becomes visible through the small promises we keep.',
      author: 'Positive Quotes',
      tags: ['love'],
    },
    {
      id: 'love-3',
      content:
        'A kind presence can say more than a perfect sentence.',
      author: 'Positive Quotes',
      tags: ['love'],
    },
  ],
  ...
  friendship: [
    {
      id: 'friendship-1',
      content:
        'A good friend makes honesty feel safer than pretending.',
      author: 'Positive Quotes',
      tags: ['friendship'],
    },
    {
      id: 'friendship-2',
      content:
        'Friendship is built from ordinary moments remembered together.',
      author: 'Positive Quotes',
      tags: ['friendship'],
    },
    {
      id: 'friendship-3',
      content:
        'The best company leaves you more yourself, not less.',
      author: 'Positive Quotes',
      tags: ['friendship'],
    },
  ],
  ...
  life: [
    {
      id: 'life-1',
      content:
        'Life changes shape when you begin choosing on purpose.',
      author: 'Positive Quotes',
      tags: ['life'],
    },
    {
      id: 'life-2',
      content:
        'You do not need the whole map to take the next honest step.',
      author: 'Positive Quotes',
      tags: ['life'],
    },
    {
...
function randomFallbackQuote(tags = '') {
  ...
  if (
    ...
    const categoryQuote =
      categoryPool[
        Math.floor(
          Math.random() * categoryPool.length
        )
      ];
  ...
  const quote =
    localQuotes[
      Math.floor(
        Math.random() * localQuotes.length
      )
    ] || {
      id: 'fallback-default',
      content:
        'A small positive step still moves the story forward.',
      author: 'Positive Quotes',
      tags: ['positive'],
    };
...
async function handleQuoteRequest(
  ...
  try {
    ...
    if (!remoteResponse.ok) {
      throw new Error(
        `DummyJSON returned ${remoteResponse.status}`
      );
    }
    ...
    if (
      !remoteQuote ||
      typeof remoteQuote.quote !== 'string'
    ) {
      throw new Error(
        'DummyJSON returned an invalid quote.'
      );
    }
